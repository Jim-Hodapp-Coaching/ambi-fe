...
const Dashboard: React.FC<any> = ({}) => {
  ...
  }, [listening, readings, lastReading]);

  return (
    <Fragment>
      <Head>
        <title>Dashboard | Ambi</title>
      </Head>
      <DashboardTemperature
        sx={{ height: "100%" }}
        value={lastReading.temperature}
      />
      <DashboardPressure sx={{ height: "100%" }} value={lastReading.pressure} />
      <DashboardHumidity sx={{ height: "100%" }} value={lastReading.humidity} />
      <DashboardDust
        sx={{ height: "100%" }}
